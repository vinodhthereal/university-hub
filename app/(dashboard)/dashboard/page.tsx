...
import { Grid, Card, Text, Title, Group, RingProgress, SimpleGrid, Paper, Stack, Badge } from '@mantine/core'
      ...
      <Grid gutter="lg">
        <Grid.Col span={{ base: 12, md: 8 }}>
          <Paper p="lg" radius="md" withBorder>
            <Title order={4} mb="md">Weekly Attendance Overview</Title>
        ...
        <Grid.Col span={{ base: 12, md: 4 }}>
          <Paper p="lg" radius="md" withBorder h="100%">
            ...
            <Stack>
              ...
              <div>
                <Text size="sm" color="dimmed">Pending Out-passes</Text>
                <Text size="lg" fw={600}>7</Text>
              </div>
              <div>
                <Text size="sm" color="dimmed">Library Books Issued</Text>
                <Text size="lg" fw={600}>156</Text>
              </div>
              <div>
                <Text size="sm" color="dimmed">Upcoming Exams</Text>
                <Text size="lg" fw={600}>3</Text>
              </div>
            </Stack>
          </Paper>
        </Grid.Col>
          ...
          <Paper p="lg" radius="md" withBorder>
            ...
            <Stack gap="sm">
              ...
              <Group justify="space-between" className="py-2 border-b">
                ...
                <Text size="xs" color="dimmed">3 hours ago</Text>
              </Group>
              <Group justify="space-between" className="py-2 border-b">
                <Text size="sm">Out-pass approved</Text>
                <Text size="xs" color="dimmed">5 hours ago</Text>
              </Group>
            ...
            <Stack gap="md">
              ...
              <div>
                <Group justify="space-between" mb="xs">
                  ...
                  <Text size="sm" fw={600}>79%</Text>
                </Group>
                <RingProgress
                  size={24}
                  thickness={4}
                  sections={[{ value: 79, color: 'yellow' }]}
                />
              </div>
            </Stack>
          </Paper>
